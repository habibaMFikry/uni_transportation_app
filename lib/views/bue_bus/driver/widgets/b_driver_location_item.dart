...
import '../b_driver_map_view.dart';

class BDriverLocationItem extends StatelessWidget {
  const BDriverLocationItem({super.key, required this.location});
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (builder) => BDriverMapView(location: location),
          ),
        );
      },
      child: Padding(
