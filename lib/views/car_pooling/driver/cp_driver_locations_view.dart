...
import 'widgets/cp_driver_locations_item.dart';

class CpDriverLocationsView extends StatelessWidget {
  static const routeName = 'cp-driver-location-view';
  const CpDriverLocationsView({super.key});
