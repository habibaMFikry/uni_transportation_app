...
import 'cp_driver_edit_profile.dart';

class CpDriverProfileView extends StatefulWidget {
  static const routeName = '/cp-driver-profile';
  const CpDriverProfileView({super.key});

  @override
  State<CpDriverProfileView> createState() => _CpProfileViewState();
}

class _CpProfileViewState extends State<CpDriverProfileView> {
  @override
  void initState() {
                ...
                IconButton(
                  onPressed: () {
                    Navigator.of(context)
                        .pushNamed(CpEditDriverProfile.routeName);
                  },
